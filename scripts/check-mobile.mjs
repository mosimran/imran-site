...
const PATHS = (process.argv[2] || '/,/papers/,/papers/retry-storm/,/impl/,/impl/mevrik-cx/,/errata/,/cv/,/history/,/l/,/tools/,/tools/in/ai-assistants/,/tools/in/editors/,/tools/github-copilot/,/scan/').split(',')
